...
export default function Navbar({ onSearchChange }) {
  ...
  return (
    <nav className="grid grid-cols-3 justify-between px-24 py-4 bg-[#3B1C32] items-center">
      <ul>
      ...
      <ul className="flex justify-center items-center">
        <li className="w-full">
          <input
            type="text"
            className="text-black active:text-black rounded-[8px] focus:text-black px-4 py-2 w-full"
            name="search"
            id={inputId}
